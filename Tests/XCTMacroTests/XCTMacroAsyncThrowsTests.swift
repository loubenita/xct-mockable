        ...
        assertMacroExpansion(
            ...
            class AsyncThrowsProtocolMock: AsyncThrowsProtocol, XCTMockProtocol {
                ...
                func fetchData() async throws -> XCTMockable.Mockable<XCTMockable.FunctionDeclaration, () async throws -> Void, Void> {
                    return XCTMockable.Mockable<XCTMockable.FunctionDeclaration, () async throws -> Void, Void>(
                        context: context,
                        invocation: XCTMockable.Invocation(
                            key: "func fetchData() async throws -> Void",
                            members: []
                        ),
        ...
        assertMacroExpansion(
            ...
            class AsyncThrowsProtocolMock: AsyncThrowsProtocol, XCTMockProtocol {
                ...
                func fetchData() async throws -> XCTMockable.Mockable<XCTMockable.FunctionDeclaration, () async throws -> Product, Product> {
                    return XCTMockable.Mockable<XCTMockable.FunctionDeclaration, () async throws -> Product, Product>(
                        context: context,
                        invocation: XCTMockable.Invocation(
                            key: "func fetchData() async throws -> Product",
                            members: []
                        ),
        ...
        assertMacroExpansion(
            ...
            class AsyncThrowsProtocolMock: AsyncThrowsProtocol, XCTMockProtocol {
                ...
                func fetchProduct(id: Int) async throws -> XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ id: Int) async throws -> Product, Product> {
                    return XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ id: Int) async throws -> Product, Product>(
                        context: context,
                        invocation: XCTMockable.Invocation(
                            key: "func fetchProduct(id: Int) async throws -> Product",
        ...
        assertMacroExpansion(
            ...
            class AsyncThrowsProtocolMock: AsyncThrowsProtocol, XCTMockProtocol {
                ...
                func getProductPrice(id: Int) async throws -> XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ id: Int) async throws -> Float, Float> {
                    return XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ id: Int) async throws -> Float, Float>(
                        context: context,
                        invocation: XCTMockable.Invocation(
                            key: "func getProductPrice(id: Int) async throws -> Float",
                            members: [XCTMockable.InvocationMember(base: id)]
                        ),
        ...
        assertMacroExpansion(
            ...
            class AsyncThrowsProtocolMock: AsyncThrowsProtocol, XCTMockProtocol {
                ...
                func doesProductExist(id: Int) async throws -> XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ id: Int) async throws -> Bool?, Bool?> {
                    return XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ id: Int) async throws -> Bool?, Bool?>(
                        context: context,
                        invocation: XCTMockable.Invocation(
                            key: "func doesProductExist(id: Int) async throws -> Bool?",
                            members: [XCTMockable.InvocationMember(base: id)]
                        ),
