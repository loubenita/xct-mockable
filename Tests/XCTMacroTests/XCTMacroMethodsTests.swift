        ...
        assertMacroExpansion(
            ...
            class MethodsProtocolMock: MethodsProtocol, XCTMockProtocol {
                ...
                func update(id: String) -> XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ id: String) -> Void, Void> {
                    return XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ id: String) -> Void, Void>(
                        context: context,
                        invocation: XCTMockable.Invocation(
                            key: "func update(id: String) -> Void",
        ...
        assertMacroExpansion(
            ...
            class MethodsProtocolMock: MethodsProtocol, XCTMockProtocol {
                ...
                func fetchContents(_ ids: String...) -> XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ ids: String...) -> String, String> {
                    return XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ ids: String...) -> String, String>(
                        context: context,
                        invocation: XCTMockable.Invocation(
                            key: "func fetchContents(_ ids: String...) -> String",
        ...
        assertMacroExpansion(
            ...
            class MethodsProtocolMock: MethodsProtocol, XCTMockProtocol {
                ...
                func fetchProduct(id: Int, key: String) -> XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ id: Int, _ key: String) -> [Product]?, [Product]?> {
                    return XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ id: Int, _ key: String) -> [Product]?, [Product]?>(
                        context: context,
                        invocation: XCTMockable.Invocation(
                            key: "func fetchProduct(id: Int, key: String) -> [Product]?",
        ...
        assertMacroExpansion(
            ...
            class MethodsProtocolMock: MethodsProtocol, XCTMockProtocol {
                ...
                func fetchProduct(id: Int) -> XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ id: Int) -> Product, Product> {
                    return XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ id: Int) -> Product, Product>(
                        context: context,
                        invocation: XCTMockable.Invocation(
                            key: "func fetchProduct(id: Int) -> Product",
                            members: [XCTMockable.InvocationMember(base: id)]
                        ),
                        returnType: Swift.ObjectIdentifier((Product).self))
                }
        ...
        assertMacroExpansion(
            ...
            class MethodsProtocolMock: MethodsProtocol, XCTMockProtocol {
                ...
                func fetchData() -> XCTMockable.Mockable<XCTMockable.FunctionDeclaration, () -> String, String> {
                    return XCTMockable.Mockable<XCTMockable.FunctionDeclaration, () -> String, String>(
                        context: context,
                        invocation: XCTMockable.Invocation(
                            key: "func fetchData() -> String",
                            members: []
                        ),
                        returnType: Swift.ObjectIdentifier((String).self))
                }
