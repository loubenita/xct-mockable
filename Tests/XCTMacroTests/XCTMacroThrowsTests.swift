        ...
        assertMacroExpansion(
            ...
            class ThrowsProtocolMock: ThrowsProtocol, XCTMockProtocol {
                ...
                func fetchData() throws -> XCTMockable.Mockable<XCTMockable.FunctionDeclaration, () throws -> String, String> {
                    return XCTMockable.Mockable<XCTMockable.FunctionDeclaration, () throws -> String, String>(
                        context: context,
                        invocation: XCTMockable.Invocation(
                            key: "func fetchData() throws -> String",
                            members: []
                        ),
        ...
        assertMacroExpansion(
            ...
            class ThrowsProtocolMock: ThrowsProtocol, XCTMockProtocol {
                ...
                func fetchProducts(ids: [Int]) throws -> XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ ids: [Int]) throws -> [Product], [Product]> {
                    return XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ ids: [Int]) throws -> [Product], [Product]>(
                        context: context,
                        invocation: XCTMockable.Invocation(
                            key: "func fetchProducts(ids: [Int]) throws -> [Product]",
        ...
        assertMacroExpansion(
            ...
            class ThrowsProtocolMock: ThrowsProtocol, XCTMockProtocol {
                ...
                func fetchProduct(id: Int) throws -> XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ id: Int) throws -> Product, Product> {
                    return XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ id: Int) throws -> Product, Product>(
                        context: context,
                        invocation: XCTMockable.Invocation(
                            key: "func fetchProduct(id: Int) throws -> Product",
        ...
        assertMacroExpansion(
            ...
            class ThrowsProtocolMock: ThrowsProtocol, XCTMockProtocol {
                ...
                func update(id: String) throws -> XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ id: String) throws -> Void, Void> {
                    return XCTMockable.Mockable<XCTMockable.FunctionDeclaration, (_ id: String) throws -> Void, Void>(
                        context: context,
                        invocation: XCTMockable.Invocation(
                            key: "func update(id: String) throws -> Void",
                            members: [XCTMockable.InvocationMember(base: id)]
                        ),
